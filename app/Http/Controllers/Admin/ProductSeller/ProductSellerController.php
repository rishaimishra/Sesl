...
class ProductSellerController extends Controller
{
        ...
        $grid = (new Grid())
            ...
            ->setColumns([
                ...
                [
                    ...
                    'icon' => 'remove_red_eye',
                    'url' => function ($item) {
                        return route('admin.productseller.edit', $item->id);
                    }
                ]

            ])->generate();
        return view('admin.productseller.grid', compact('grid'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('admin.productseller.edit', compact('categories', 'product', 'attributeGroups', 'attributeSets'));
    }
    ...
    public function update(Product $product, Request $request)
    {
        ...
        return redirect()->route('admin.productseller.index')->with($this->setMessage('Product Update Successfully', self::MESSAGE_SUCCESS));
    }
    ...
    public function destroy(Product $product, Request $request)
    {
        ...
        return redirect()->route('admin.productseller.index')
